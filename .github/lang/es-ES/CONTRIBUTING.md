...
Empieza una [nueva discusión](https://github.com/josantonius/php-language-code/discussions/new) y selecciona
...
abre una [nueva discusión](https://github.com/josantonius/php-language-code/discussions/new) en la categoría
...
[repositorio](https://github.com/josantonius/php-language-code). O mejor aún, puedes
...
[Envía un nuevo _issue_](https://github.com/josantonius/php-language-code/issues/new) para reportar un error.
...
1. Busca en [GitHub](https://github.com/josantonius/php-language-code/pulls) si existe algún tema relacionado
para asegurarte que no esté repetido.

1. [Bifurca](https://github.com/josantonius/php-language-code/fork) el repositorio a tu propia cuenta de GitHub.
...
1. En GitHub, envía un [_pull request_](https://github.com/josantonius/php-language-code/compare/main..)
hacia `php-language-code:main`.
